...
sudo /home/inspur/miniconda3/bin/python3 src/launch.py --master 1 --ip 192.168.3.15 --worker_num 2 --config_file config/workers.json --dataset CIFAR100 --model resnet50